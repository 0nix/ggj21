const script = {
    ...
    a3a:`[say]"Agent, I'm sure that setting up an operation on such short notice is not something you may want to do every day," Bayer quizzes. "But, I find it hard to believe that there was a complete lack of any evidence on either party under surveillance."`,
    a4a:`[say]"Are you trying to pull the wool over our eyes, Brownie? Is Leitzka a friend of yours? Is Hassel?" Bryce accuses, with some anger in his voice. "If so, you are entirely inappropriate for this operation and we have wasted precious resources from your lack of professionalism."`,
    ...
    b2a:"[LOCKCHAR]",
    b3a:"[SETCHAR]EV1-1",
    b4a:"[say]Bryce and Bayer hear your report on Hassel's apparent material wealth. Both men stay in silence for a moment. They look at each other with a bit of amusement.",
    ...
    b6a:`[say]"Bayer, please." Bryce interjects. "Exactly how often can you afford to have a high ticket item on your kitchen that doesn't disappear in a day, hmm? Specially when, as the Agent has said, hams have not been in distribution for weeks?"`,
    ...
    b14a:`[jmp]b999a`,
    b15a:`[say]You lend credence to Bayer's objections and make a note to expunge the evidence from the surveillance record. Bryce is nonchalant about it, showing his displeasure with a pursed lip, showing his yellow ghoulish teeth.`,
    b999a:"[UNLOCKCHAR]",
    ...
    c11a:`[say]"You knew well what I mean Lieutenant, being obtuse gets us nowhere." Bayer barks at Bryce, with annoyance. "We cannot establish a pattern unless we see a repeated incidence of behavior, but I do believe this should be entered into evidence."`,
    c12a: {
        instruction: "dec",
        content: `"It's a coincidence, Sergeant Bayer." Bryce proclaims. "Nothing more, nothing less."`,
        opts: {
            choices: [
                {
    ...
    d2a: "[LOCKCHAR]",
    d3a: "[SETCHAR]EV1-3",
    d4a: "[say]Bryce and Bayer listen to you make a note of Hassel owning two sofas not being much in line with someone of his earned income and station. Evidence may suggest that he is receiving more money than is reported in official documentation.",
    ...
    d6a:{
        instruction:"dec",
        content:`"Not to mention that's there's already something in file that explains this course of action, Hassel was unfortunately involved with an element that has been taken care of and if I think owning a piece of furniture from a friend is not against the law." Bryce agrees, a surprised look on his face. <br/><br/> "Now, Agent, please tell us why we should even entertain this piece of evidence to be included into the dossier." Bayer says, rapping his finger on the papers.`,
        opts: {
            choices: [
                {
    ...
    d7a:`[say]You say that precisely owning belongings that are potentially from a previous association are more than enough to arise suspicion of subversive attitudes. The rational thing would have been to shun and disassociate from the relation for one's own benefit and the country's.`,
    d8a:`[say]Bryce nods in agreement. Bayer shakes his head. "If the Lieutenant wants to continue with our previous pattern in leaping to conclusions, I cannot help but think this is a gross misuse of state resources."<br/><br/>"What do you mean, Bayer?" Bryce asks, annoyed. /n/n Sergeant Bayer sighs and raises his hands. "Add it to the record if you want, Bryce. I will not be co-signing sloppy work."`,
    ...
    d24a: `[say]"Unbelievable," Bryce says, angrily. "This kind of reasoning is going to convince you to note the subject's choice of home décor. This will put anti-citizen elements behind bars, Bryce? Really?" He says with and increasingly louder voice.`,
    d25a: `[say]"I was very clear with my assessment, Lieutant." Bayer responds, leaning on the last word of that sentence. "I think it's worth pursuing for any other behaviors that are not consistent. The Agent's right to point it out even if it's slim."`,
    ...
    e7a:{
        instruction: "dec",
        content: `"We didn't start surveillance on this man out of the blue, Sergeant." Bryce responds. "This fits a pattern of behavior that precisely justifies surveillance. Intelligence has put him on a list for reasons of state security If Division XXI has reason to suspect something through independent informants, then we should heed their call."`,
        opts: {
            choices: [
                {
    ...
    z3a: "[say]And with that, they leave. You are now completely alone.",
    z4a: "[lxs]day2",
    z999a:"[end]"
}

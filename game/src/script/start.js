const script = {
  ...
  ce: {
    ...
    opts: {
      choices: [
        {
          content: `It's the probably the millionth time you've heard the joke, but because it's Sessler by God you have to put on a shit-munching smile and sell that it's the first time you're hearing this.`,
          line: "[jmp]ceb",
        },
        {
          content: "You say nothing.",
  ...
  ceb: `[say]With a brief chuckle, you respond. "I had not thought about that sir, Services has quite the sense of humor then."<br/><br/>Sessler grunted in approval. He picked up a couple of papers attached together with a clip and slid them across the table to you.`,
  ...
  f5b: "[jmp]g1a",
  f1c: `[say]Lieutenant Sessler grunts, annoyed. "If this were a year or two ago, Brownie, I wouldn't even bother with it. But I'm in no mood to anger Sargeant Bayer with warrantless arrests. After all, the Party wants results, as if we didn't get them already." Spite laced his last words.`,
  ...
  g1a: `[say]Leiutenant Sessler gets up, the metal chair making an extremely nasty noise as he rises. You get up as well.`,
  ...
  e3a: `[say]You hand him the paperwork signed with Sessler's name, and he quickly scans it.`,
  e4a: `[say]"May I have the rest of the documentation, Agent?" You obey. Bayer did not need long to understand the situation. `,
  e5a: {
    instruction: "dec",
    content: `"Typical Sessler operation. If it were up to him he'd try to get nine women pregnant to deliver a baby in a month. Four days for a comprehensive surveillance and official warrant is not nearly enough. Looks like you've drawn the short stick, Agent 8R0W1713."`,
    opts: {
      choices: [
        {
  ...
  h1a: `[say]"I have to say," Sargeant Bayer says with a huff "the alacrity of this job that Sessler has assigned to you is rather odd. Very conveniently for our timing with the United Left operation at the Nineteenth."`,
  h2a: `[say]He stops a moment to think, leans forward and adopts a much more serious façade.`,
  h3a: `[say]"Agent 8R0W713, you are hererby assigned an additional task. It is clear that Sessler wants something more than the safety of this country, and he has been personally compromised. As you report at the end of every workday in the surveillance of this Mr. Hassel and Ms. Leitzka I will join the briefing. I expect you to truthful of what you see, and find evidence of Sessler's personal involvement in this affair. I am sure Sessler is using the State as his personal cudgel and I will need require evidence for this crime. Same standards apply. Counter-intelligence would be thrilled to find a little tyrant in the company, and you will be rewarded for it.`,
